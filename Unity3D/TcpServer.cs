    ...
    public class AsyncTcpServer : IDisposable
    {
        ...
        private void ContinueAcceptTcpClient(TcpListener tcpListener)
        {
            ...
            try
            {
                ...
                //Console.WriteLine("end BeginAcceptTcpClient" + client.ToString());
        ...
        public async void AcceptTcpClient()
        {
            try
            {
        ...
        private void HandleTcpClientAccepted(IAsyncResult ar)
        {
            ...
            Console.WriteLine("HandleTcpClientAccepted r1");
            ...
            Console.WriteLine("HandleTcpClientAccepted r4");

            RaiseClientConnected(tcpClient);

            Console.WriteLine("HandleTcpClientAccepted r5");

            // begin to read data
            NetworkStream networkStream = internalClient.NetworkStream;
            ContinueReadBuffer(internalClient, networkStream);

            Console.WriteLine("HandleTcpClientAccepted r6");
        ...
        private void HandleDatagramReceived(IAsyncResult ar)
        {
            if (!IsRunning)
                return;
            Console.WriteLine("HandleDatagramReceived r0");
            try
            {
                ...
                Console.WriteLine("HandleDatagramReceived r3");
        ...
        private void RaiseClientConnected(TcpClient tcpClient)
        {
            ...
            {
                Console.WriteLine("RaiseClientConnected");
                MainThreadDispatcher.Run(() =>
                {
                    ClientConnected(this, new TcpClientConnectedEventArgs(tcpClient));
                });
                Console.WriteLine("RaiseClientConnected end");
            }
        }
