...
namespace Poco
{
    public class AbstractDumper : IDumper
    {
        ...
        public bool ContainNode(string text)
        {
            return getRoot().ContainNodeImpl( text);
        }
        ...
        {
            getRoot().SetFieldNameImpl(text);
        }
        
        public AbstractNode? GetFieldNameNode()
        {
            return getRoot().GetFieldNameNode();
        }
